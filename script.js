...
class AppleScrollAnimations {
    ...
    initScrollAnimations() {
        const elements = {
            ...
            paragraphs: document.querySelectorAll('p.text-xl, p.text-gray-300, p.text-gray-400'),
    ...
    animateSection(section) {
        ...
        const paragraphs = section.querySelectorAll('p.text-xl, p.text-gray-300, p.text-gray-400');
...
scrollToTopBtn.className = 'fixed bottom-8 right-8 w-14 h-14 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-xl font-bold shadow-lg hover:shadow-cyan-500/50 transition-all opacity-0 pointer-events-none z-50';
...
// Console Branding
console.log('%c🚀 KIRALCORE ', 'background: linear-gradient(90deg, #00F5FF, #0066FF); color: white; font-size: 24px; padding: 10px 20px; border-radius: 8px; font-weight: bold;');
console.log('%c✨ İşletmenizi AI ile Dönüştürün', 'font-size: 16px; color: #00F5FF; font-weight: bold; margin-top: 10px;');
console.log('%c💎 Premium Space-Tech Design', 'font-size: 14px; color: #0066FF;');
